...
public class PrintJobIdInformationInfo {
    public static void main(String[] args) throws Exception {
        ...
        for (String logLine : logLines) {
            ...
            if (!(logLine.contains("memory.MemoryStore:") || logLine.contains("scheduler.TaskSetManager:")
                    ...
                    || logLine.contains("ContextCleaner: Cleaned ")
                    || logLine.contains("ContextCleaner:54") || logLine.contains("ContextCleaner:58")
                    || logLine.contains("spark.SparkContext: Created broadcast") || logLine.contains("SparkContext:54 - Created broadcast")
                    || logLine.contains("spark.SparkContext: Created broadcast") || logLine.contains("BlockManagerInfo:54")
